              ...
              <form class="form-horizontal" method="post" action="{{route('user.update',$data->id)}}">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="name" class="form-control" value="{{$data->name}}" id="inputNama" placeholder="ex: 12">
                      @if ($errors->has('name'))
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" name="email" class="form-control" value="{{$data->email}}" id="inputEmail" placeholder="ex: 12">
                      @if ($errors->has('email'))
                          <span class="text-danger">
                              {{$errors->first('email')}}
                          </span>
