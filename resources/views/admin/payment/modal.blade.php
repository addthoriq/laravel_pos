  ...
  <div class="modal-dialog" role="document" style="width: 800px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel"><i class="fa fa-dollar "></i> Detail Pemabayaran</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a href="{{url('admin/payment/'.$row->id.'/edit')}}" class="btn btn-warning btn-sm"><i class="fa fa-cog"></i> Ubah</a>
      </div>
    </div>
  </div>
</div>
